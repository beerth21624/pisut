...
const ProofreadingApp: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError(null);
    try {
      const response = await axios.post<ProofreadResult>('https://general-pisut-be.tu4rl4.easypanel.host/proofread', { text: inputText },{
...
export default ProofreadingApp;